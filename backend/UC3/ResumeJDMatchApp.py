...
# ------------------- Agents -------------------
from backend.UC3.src.CoverLetterAgent import CoverLetterAgent
from backend.UC3.src.JDUnderstandingAgent import JDUnderstandingAgent
from backend.UC3.src.MatchingAgent import MatchingAgent
from backend.UC3.src.ResumeEnhancerAgent import ResumeEnhancerAgent
from backend.UC3.src.ResumeParsingAgent import ResumeParsingAgent
